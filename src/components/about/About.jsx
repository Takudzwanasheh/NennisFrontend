		...
		<div className='about-container'>
			...
			<div className='about-content'>
				<p>
					...
					and the greater the probability that the group will achieve its
					goals.-Rensis Likert”
				</p>
				<p>
					...
					favourable working conditions and we reward them competitively thereby
					ensuring that we gain and develop a competitive advantage. We believe
					strongly in self-development and invest a great deal towards this
					cause.
				</p>
			</div>
		</div>
